...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and matches for school soccer players",
    ...
    "Swimming Club": {
        ...
        "max_participants": 16,
        "participants": ["luke@mergington.edu", "isabel@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and creative design projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "maria@mergington.edu"]
    },
    "Drama Workshop": {
